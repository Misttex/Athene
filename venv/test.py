...
def index():
    ...
    return render_template('layout/index.html', session=session, message=message)
...
def users():
    ...
    if not users:
        ...
        return render_template('layout/users.html', message=message)
    return render_template('layout/users.html', users=users, message=message)
...
def login():
    ...
    if request.method == 'POST':
        ...
        if not result:
            ...
            return render_template('layout/login.html', message=message)
...
def register():
    ...
    if request.method == 'POST':
        ...
        if not result:
            ...
            return render_template('layout/register.html', message=message)
